...
export const startSession = ({ args = [], headless = 'auto', customConfig = {}, proxy = {} }) => {
    return new Promise(async (resolve, reject) => {
        try {
            ...
            const chromeFlags = ['--window-size=1920,1080'].concat(args);
            ...
            const EXTENSION_PATH = `${dirPath}/extension/turnstile`;
            const EXTENSION_PATH2 = `${dirPath}/extension/0.4.12_0/`;
            chromeFlags.push(`--disable-extensions-except=${EXTENSION_PATH},${EXTENSION_PATH2}`)
            chromeFlags.push(`--load-extension=${EXTENSION_PATH},${EXTENSION_PATH2}`)
