...
const Ext = "C:\\Users\\mroin\\AppData\\Local\\Google\\Chrome\\User Data\\Profile 1\\Extensions\\dknlfmjaanfblgfdfebhijalfmhmjjjo\\0.4.12_0";
...
await page.waitForSelector(`input[name=${Config.sites[i].input}]`, {timeout: 0});
    ...
    if(Checked) {
        ...
        if(Config.sites[i].index == 7) {
            ...
            if(Result === "Thanks, Vote Registered") {
                ...
                await page.waitForSelector("div[class=modal-body text-center]");
